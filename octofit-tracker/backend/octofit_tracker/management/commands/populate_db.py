...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Create workouts
        w1 = Workout.objects.create(name='Super Strength', description='Strength training for superheroes', difficulty='Hard')
        w2 = Workout.objects.create(name='Flight Training', description='Aerobic workout for flying heroes', difficulty='Medium')
